...
S=2.55
L=88/math.sin(math.radians(50)); run=88/math.tan(math.radians(50))
...
def panel(base,up):
 ...
 line(X(269),Z(106),X(69.75),Z(106),'#406b7c',7)
 text(100,base-292,'Loft +8′ 10″ proposed',17,'#406b7c')
 for name,y in [('W4',269),('W3',185),('W2',69.75),('W1',-66)]:
  line(X(y),base,X(y),Z(106),'#8ca0a7',6)
  text(X(y)-15,base+25,name,17)
  line(X(y),base+32,X(y),base+54,'#a9b0b0',1)
 # loft opening / fixed stair
 line(X(185),Z(106),X(149),Z(106),'#faf9f5',9)
 poly([(X(185),Z(106)),(X(185),Z(97)),(X(176),Z(97)),(X(176),Z(88)),(X(167),Z(88)),(X(149),Z(88))],'#b17a36',5)
 ...
 def pt(a,b):
  ...
  return X(149)+S*(a*math.cos(angle)+b*math.sin(angle)), Z(88)+S*(a*math.sin(angle)-b*math.cos(angle))
 ...
 text(px+34,py-45,'Pivot +7′ 4″',17,'#9c672a')
 if up:
  tx,ty=pt(L,0)
  poly([(tx,ty),(tx+30,ty-45),(tx+220,ty-45)],'#c35b3c',1)
  text(tx+35,ty-70,'Stored flight ≈9′ 7″',17,'#a7472e')
  text(tx+35,ty-48,'Ends ≈2′ 11⅝″ past W2',16,'#a7472e')
  # beam circle
  parts.append(f'<circle cx="{X(69.75)}" cy="{Z(93)}" r="25" fill="none" stroke="#b17a36" stroke-width="2" stroke-dasharray="4 4"/>')
  ...
  text(510,base-120,'Walkway: clear height less than 7′ 4″',17,'#75817e')
  text(510,base-97,'Deduct stair depth, hardware and ground variation.',15,'#75817e')
 else:
  text(820,base-135,'50° study angle',19,'#a7472e')
  text(820,base-108,'Foot ≈5⅜″ north of W2',16,'#a7472e')
...
text(70,134,'ST-02 · Lower loft study · 15 Sep 2026 · Dimensioned study, not a construction drawing',15,'#75817e')
panel(640,True)
panel(1225,False)
line(70,745,1430,745,'#d5d9d7',1)
text(70,1340,'ASSUMPTIONS &amp; LIMITS',18)
text(70,1371,'Loft +106″; pivot +88″; level outside landing at 0″. Heights and 50° pitch are illustrative, not adopted or code-approved.',16)
text(70,1397,'Plan posts retained. Treads and rails schematic, not a stair schedule. Fixed steps, platform and mechanism require design.',16)
text(70,1423,'Loft is only 7½″ above existing wall top. Retained roof / beam / deck fit needs a transverse section; upper roof omitted.',16)
...
parts.append('</svg>')
(P/'west-elevation-stairs-8ft10.svg').write_text('\n'.join(parts))
