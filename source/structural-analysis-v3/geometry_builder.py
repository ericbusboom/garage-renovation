...
BASE=Path(__file__).parent;ROOT=BASE.parent;TRIANGULATED=os.environ.get('TRUSS_OPTION')=='triangulated';SHEAR_SEATS=os.environ.get('SHEAR_SEATS')=='1';OUT=BASE/'generated-input';OUT.mkdir(exist_ok=True)
