...
The workspace outside this directory remains the working archive. It contains experiments, scripts, earlier concepts, renderings, and superseded analyses. Nothing becomes part of the controlled report merely because it exists elsewhere in the project.
