...
a.CAD=cad
(P/'braced3-candidate-geometry.json').write_text(json.dumps(cad,indent=2));(P/'braced3-candidate-selection.json').write_text(json.dumps(sel,indent=2))
for name,kw in [('braced3_complete',{}),('braced3_roof_first',{'study_stage':'roof_first'}),('braced3_base_pinned',{'base_pinned':True})]:
