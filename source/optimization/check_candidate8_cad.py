...
new=A.openDocument(str(P/'Garage-Candidate-8.FCStd'));old=A.openDocument(str(P.parent/'Existing-Garage.FCStd'))
...
(P/'candidate8-clearance-check.json').write_text(json.dumps(r,indent=2));print(json.dumps(r),flush=True)
os._exit(0)
