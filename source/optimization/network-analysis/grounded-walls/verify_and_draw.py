...
def draw(m,d,group,cols,extras=(),iso=False):
 ...
 pl.add_text(group+' | '+('Global support path' if iso else 'Full wall elevation'),position='upper_left',font_size=23,color='#203344')
 notes='Actual ground supports shown. Shared columns occur once in the global model.\nFixed-base analytical assumption; foundations and connections not designed.'
