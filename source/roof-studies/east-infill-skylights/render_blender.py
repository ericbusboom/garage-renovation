...
scene['design']='Rough roof concept: east setback infill, retained hip cap, six upper-row skylights. Historical framing for context only.';scene['engineering_limit']='Connection/secondary framing and envelope attachment not designed. This is an architectural assembly visualization.'
