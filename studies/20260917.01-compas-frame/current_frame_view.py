...
import frame_models
ROOT=Path(__file__).resolve().parents[2];P=ROOT/'studies/20260916.01-roof/square-upper-west';OUT=P/'compas';OUT.mkdir(exist_ok=True)
...
controls=(ROOT/'studies/20260917.01-compas-frame/frame_view_controls.js').read_text()
...
template=(ROOT/'studies/20260917.01-compas-frame/frame_view_template.html').read_text()
