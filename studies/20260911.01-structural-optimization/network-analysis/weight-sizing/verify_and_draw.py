...
def draw(m,d,group,cols,extras=(),iso=False):
 ...
 pl.add_text(group+' | '+('Sized support path' if iso else 'Sized truss elevation'),position='upper_left',font_size=23,color='#203344')
 notes='Fixed centerline geometry; selected stock sizes are listed in the member schedule.\nPreliminary fixed-base model; connection and foundation design remains.'
