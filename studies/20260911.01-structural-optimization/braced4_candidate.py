...
a.CAD=cad
(P/'braced4-candidate-geometry.json').write_text(json.dumps(cad,indent=2));(P/'braced4-candidate-selection.json').write_text(json.dumps(sel,indent=2))
for name,kw in [('braced4_complete',{}),('braced4_roof_first',{'study_stage':'roof_first'}),('braced4_base_pinned',{'base_pinned':True})]:
