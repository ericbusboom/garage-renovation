...
fig,axs=plt.subplots(1,2,figsize=(18,12),layout='constrained',gridspec_kw={'width_ratios':[1,1.2]})
...
ax=axs[1]
ax.add_patch(Rectangle((0,-249),W,249,fc='#edf0ef',ec=gray,lw=2))
...
ax.set(xlim=(-48,302),ylim=(-283,119),title='UPPER-FLOOR PLAN — north up, west left')
ax.plot([0,W,W,0,0],[0,0,-249,-249,0],c='#794f83',lw=2.5,ls='--',zorder=10)
ax.text(124,-180,'EXISTING GARAGE FOOTPRINT',ha='center',color='#794f83',weight='bold')
ax.text(124,-196,'20 ft 9½ in east–west × 20 ft 9 in north–south\nCurrent drawing basis; verify against surveyed CAD',ha='center',fontsize=9,color='#794f83')
dim(ax,(0,-269),(W,-269),'249.5 in • 20 ft 9½ in',(0,-6))
dim(ax,(270,-249),(270,0),'249 in\n20 ft 9 in',(15,0))
ax.annotate('Old NORTH wall / inset upper wall',(24,0),xytext=(100,-150),arrowprops={'arrowstyle':'->','color':'#794f83'},color='#794f83',fontsize=9)
ax.text(125,-243,'Old SOUTH wall',ha='center',fontsize=9,color='#794f83')
ax.set_aspect('equal');ax.axis('off')
...
fig.savefig(P/'north-loading-jib-full-footprint.png',dpi=145);fig.savefig(P/'north-loading-jib-full-footprint.pdf')
(P/'full-footprint-basis.json').write_text(json.dumps(dict(units='inches',existing_setback=82,assumed_required_setback=60,extension=22,upper_wall_north_offset=0,outer_edge_north_offset=22,pivot=[float(x) for x in pivot],boom_radius=96,opening_west=west,opening_east=east,opening_height_assumed=84,column_width_placeholder=6,structural_design=False),indent=2))
