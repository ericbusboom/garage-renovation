...
BASE=Path(__file__).parent;ROOT=BASE.parent;TRIANGULATED=os.environ.get('TRUSS_OPTION')=='triangulated';SHEAR_SEATS=os.environ.get('SHEAR_SEATS')=='1';OUT=BASE/'shear-seats' if SHEAR_SEATS else BASE/'triangulated' if TRIANGULATED else BASE;OUT.mkdir(exist_ok=True)
...
for n,a,b in [('B2',(0,185,H),(XE,185,H)),('B3',(0,249,H),(246.5,249,H)),('T-SO',(-32,-63,H),(W,-63,H)),('B-WO',(-32,-63,H),(-32,253,H)),('O2',(-32,69.75,H),(0,69.75,H)),('O3',(-32,185,H),(0,185,H))]:line(n,'beam',a,b)
...
def floorroute(k,x,y,lb):
 ys=[69.75,185,249];names=['T1','B2','B3'];i=0 if y<185 else 1;t=(y-ys[i])/(ys[i+1]-ys[i])
...
ys=sorted(set([72,219,255,185,249]+list(np.linspace(72,255,25))))
